...
oclif-plugin-update-notifier/1.5.146 linux-x64 node-v24.11.1
...
_See code: [src/commands/plugins/update/check.ts](https://github.com/jayree/oclif-plugin-update-notifier/blob/v1.5.146/src/commands/plugins/update/check.ts)_
<!-- commandsstop -->
