...
oclif-plugin-update-notifier/1.5.168 linux-x64 node-v24.16.0
...
_See code: [src/commands/plugins/update/check.ts](https://github.com/jayree/oclif-plugin-update-notifier/blob/v1.5.168/src/commands/plugins/update/check.ts)_
<!-- commandsstop -->
