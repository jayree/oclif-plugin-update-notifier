...
oclif-plugin-update-notifier/1.5.129 linux-x64 node-v22.17.1
...
_See code: [src/commands/plugins/update/check.ts](https://github.com/jayree/oclif-plugin-update-notifier/blob/v1.5.129/src/commands/plugins/update/check.ts)_
<!-- commandsstop -->
