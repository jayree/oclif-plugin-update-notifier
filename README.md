...
oclif-plugin-update-notifier/1.5.58 linux-x64 node-v20.10.0
...
_See code: [lib/commands/plugins/update/check.ts](https://github.com/jayree/oclif-plugin-update-notifier/blob/v1.5.58/lib/commands/plugins/update/check.ts)_
<!-- commandsstop -->
